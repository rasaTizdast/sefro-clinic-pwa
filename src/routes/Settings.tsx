...
import { BiUser, BiBuildings, BiGroup, BiBell, BiPencil, BiTrash, BiPlus, BiSave, BiLock, BiPhone } from 'react-icons/bi'
...
const roleBadgeVariant: Record<ClinicUser['role'], 'success' | 'info' | 'warning'> = {
  مدیر: 'success',
  پزشک: 'info',
  منشی: 'warning',
}
...
const mockUsers: ClinicUser[] = [
  { id: 1, username: 'dr.mohammadi', role: 'مدیر', email: 'dr.mohammadi@clinic.com', status: 'active' },
  { id: 2, username: 'dr.hosseini', role: 'پزشک', email: 'dr.hosseini@clinic.com', status: 'active' },
  { id: 3, username: 'sara.nik', role: 'منشی', email: 'sara.nik@clinic.com', status: 'active' },
  { id: 4, username: 'ali.ahmadi', role: 'پزشک', email: 'ali.ahmadi@clinic.com', status: 'inactive' },
...
function Settings() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-bold text-surface-900">تنظیمات</h1>
        ...
        <div className="flex flex-col gap-6">
          <Card variant="outlined" padding="lg">
            <div className="flex items-center gap-4 mb-6 pb-6 border-b border-surface-200">
              ...
              <div>
                <h2 className="text-lg font-semibold text-surface-900">مدیر کلینیک</h2>
                <p className="text-sm text-surface-500">مدیر سیستم</p>
              </div>
            </div>
          ...
          <Card variant="outlined" padding="lg">
            ...
            <div className="flex flex-col gap-3">
              {workingHours.map((day, index) => (
                <div
                  key={day.day}
                  className="flex items-center gap-4 pb-3 border-b border-surface-100 last:border-b-0 last:pb-0"
                >
                  <span className="w-24 text-sm font-medium text-surface-700 shrink-0">
                    {day.day}
                  </span>
                  <Input
                    type="time"
