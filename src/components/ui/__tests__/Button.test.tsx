...
describe("Button", () => {
  ...
  it("renders startIcon", () => {
    const { container } = render(<Button startIcon={<span data-testid="start-icon">*</span>}>Click</Button>);
    expect(container.querySelector("[data-testid='start-icon']")).toBeInTheDocument();
  });

  it("renders iconOnly without text", () => {
    render(<Button iconOnly aria-label="Search"><svg data-testid="icon" /></Button>);
